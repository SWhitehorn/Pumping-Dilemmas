export default {
  ...
  loop1Data: {
    ...
    alphabet: ["a", "b"],
    language:
      "L = { w \u{2208} {a,b}* | w contains a consecutively repeated letter }",
  },
  ...
  loop2Data: {
    ...
    alphabet: ["a", "b"],
    language:
      "L = {w \u{2208} {a,b}* | w is formed of non-overlapping substrings 'ab' and 'ba'}",
    repeats: [2, 0, 3],
    word: "baabba",
  },
  ...
  loop3Data: {
    ...
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w has an odd number of 'a's and each a is followed by at least one b",
  },
  ...
  loop4Data: {
    automata: {
      states: {
        q1: {
          ...
          transitions: { b: ["q2"], a: ["q3"] },
          controlPoints: {
            q2: { x: 392.31160441914426, y: 106.38571811092334 },
            q3: { x: 266, y: 241 },
          },
        },
        q2: {
    ...
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w has an odd number of 'a's and an even number of 'b's",
  },
    ...
    automata: {
      states: {
        ...
        q2: {
          ...
          controlPoints: {
            q4: { x: 321.9683797428539, y: 250.52449633153162 },
            q2: { x: 241, y: 187 },
          },
        },
        q3: {
        ...
        q4: {
          ...
          controlPoints: {
            q5: { x: 490.51403079428184, y: 251.31846299977565 },
            q1: { x: 246.16273050033118, y: 332.6781690823796 },
          },
        },
        q5: {
          x: 579,
          ...
          transitions: { a: ["q3"], b: ["q2"] },
          controlPoints: {
            q3: { x: 655.0041092153108, y: 250.84384981819034 },
            q2: { x: 400, y: 150 },
          },
        },
      },
  ...
  create3Data: {
    automata: {
      states: {
        q1: { x: 290, y: 460, accepting: false, transitions: {}, name: "q1" },
        q2: { x: 315, y: 460, accepting: false, transitions: {}, name: "q2" },
        q3: { x: 475, y: 460, accepting: true, transitions: {}, name: "q3" },
      },
      start: { name: "q1" },
    },
    words: [
      { word: "babab", result: true },
      { word: "ab", result: true },
      { word: "abb", result: false },
    ],
    alphabet: ["a", "b"],
  ...
  create1Data: {
    automata: {
      states: {
        q1: { x: 290, y: 460, accepting: false, transitions: {}, name: "q1" },
        q2: { x: 315, y: 460, accepting: false, transitions: {}, name: "q2" },
        q3: { x: 340, y: 460, accepting: false, transitions: {}, name: "q3" },
        q4: { x: 475, y: 460, accepting: true, transitions: {}, name: "q4" },
      },
      start: { name: "q1" },
    },
    words: [
      { word: "aabba", result: true },
      { word: "bbab", result: false },
      { word: "abb", result: true },
    ],
    alphabet: ["a", "b"],
  ...
  create2Data: {
    ...
    words: [
      { word: "aa", result: true },
      { word: "ababa", result: false },
      { word: "baba", result: true },
  ...
  createTutorialData: {
    automata: {
      states: {
        q1: { x: 400, y: 300, accepting: false, transitions: {}, name: "q1" },
        q2: {
          x: 650,
          y: 300,
          accepting: true,
  ...
  create02Data: {
    ...
    words: [
      { word: "aba", result: true },
      { word: "abab", result: false },
      { word: "b", result: false },
      { word: "abbbba", result: true },
      { word: "bba", result: false },
      { word: "aabba", result: false },
    ],
    alphabet: ["a", "b"],
    language: "L = { ab\u{207F}a | n \u{2265} 0}",
  },
  ...
  create4Data: {
    automata: {
      states: {
        ...
        q2: { x: 315, y: 460, accepting: false, transitions: {}, name: "q2" },
        q3: { x: 340, y: 460, accepting: false, transitions: {}, name: "q3" },
        q4: { x: 450, y: 460, accepting: true, transitions: {}, name: "q4" },

        q5: { x: 475, y: 460, accepting: true, transitions: {}, name: "q5" },
      },
      start: { name: "q1", direction: "top" },
    },
    words: [
      { word: "aba", result: true },
      { word: "baab", result: true },
      { word: "b", result: true },
      { word: "ab", result: false },
      { word: "bbba", result: false },
      { word: "babab", result: true },
    ],
    alphabet: ["a", "b"],
  ...
  create6Data: {
    ...
    words: [
      { word: "aaaa", result: true },
      { word: "b", result: false },
      { word: "ε", result: true },
      { word: "bba", result: false },
      { word: "abbab", result: false },
      { word: "bbaabbaa", result: true },
    ],
    alphabet: ["a", "b"],
  ...
  loop6Data: {
    ...
    words: [
      { word: "babb", result: true },
      { word: "abaa", result: true },
      { word: "aba", result: false },
      { word: "abbaab", result: false },
      { word: "bababb", result: true },
    ],
    alphabet: ["a", "b"],
  ...
  loop7Data: {
    automata: {
      states: {
        q1: { x: 450, y: 460, accepting: true, transitions: {}, name: "q1" },
        q2: { x: 475, y: 460, accepting: true, transitions: {}, name: "q2" },
      },
      start: { name: "q1" },
    },
    words: [
  ...
  add1Data: {
    automata: {
      states: {
        q1: {
          ...
          controlPoints: {
            q4: { x: 240, y: 111 },
            q5: { x: 525.0485573273558, y: 101.06937033435865 },
          },
        },
        q2: {
          x: 311,
          ...
          controlPoints: {
            q4: { x: 181.33667243959684, y: 262.18460751073127 },
            q2: { x: 311, y: 256 },
          },
        },
        q3: {
        ...
        q4: {
          ...
          controlPoints: {
            q1: { x: 241, y: 194 },
            q2: { x: 135.13951667874554, y: 313.60178087167884 },
          },
        },
        q5: {
          x: 665,
    ...
    grammar:
      "S -> ε | 31 | 42 | 33 | 44, Q -> 31 | 42 | 33 | 44, 1 -> Q3, 2 -> Q4, 3 -> a, 4 -> b",
  },
  ...
  create8Data: {
    automata: {
      states: {
        q1: { x: 290, y: 460, accepting: false, transitions: {}, name: "q1" },
        q2: { x: 315, y: 460, accepting: false, transitions: {}, name: "q2" },
        q3: { x: 425, y: 460, accepting: true, transitions: {}, name: "q3" },
        q4: { x: 450, y: 460, accepting: true, transitions: {}, name: "q4" },
        q5: { x: 475, y: 460, accepting: true, transitions: {}, name: "q5" },
      },
      start: { name: "q3" },
    ...
    words: [
      { word: "aba", result: true },
      { word: "abab", result: true },
      { word: "b", result: false },
      { word: "abba", result: false },
      { word: "bba", result: false },
      { word: "ababa", result: true },
    ],
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w consists of 0 or more concatenations of 'ab' and 'aba' }",
    loop: true,
  },
  ...
  create7Data: {
    ...
    words: [
      { word: "aba", result: true },
      { word: "abbb", result: true },
      { word: "baab", result: false },
      { word: "aaa", result: false },
      { word: "b", result: false },
      { word: "abab", result: false },
      { word: "ababa", result: true },
    ],
  ...
  nonDeterministicData0: {
    automata: {
      states: {
        ...
        q3: { x: 600, y: 200, accepting: true, transitions: {}, name: "q3" },
      },
      start: { name: "q1" },
    },
    word: "abba",
  ...
  create10Data: {
    automata: {
      states: {
        q1: { x: 290, y: 460, accepting: false, transitions: {}, name: "q1" },
        q2: { x: 425, y: 460, accepting: true, transitions: {}, name: "q2" },
        q3: { x: 450, y: 460, accepting: true, transitions: {}, name: "q3" },
        q4: { x: 475, y: 460, accepting: true, transitions: {}, name: "q4" },
      },
      start: { name: "q1" },
    },
    words: [
      { word: "abab", result: true },
      { word: "abc", result: false },
      { word: "cbbc", result: true },
      { word: "bcaaa", result: false },
      { word: "b", result: true },
    ],
    alphabet: ["a", "b", "c"],
    language:
      "L = {w\u{2208}{a,b,c}* | w does not contain every letter of the alphabet }",
    deterministic: false,
  },
  ...
  create11Data: {
    automata: {
      states: {
        q1: { x: 290, y: 460, accepting: false, transitions: {}, name: "q1" },
        q2: { x: 450, y: 460, accepting: true, transitions: {}, name: "q2" },
        q3: { x: 475, y: 460, accepting: true, transitions: {}, name: "q3" },
      },
      start: { name: "q1" },
    },
    words: [
      ...
      { word: "baba", result: true },
      { word: "abba", result: false },
      { word: "aaba", result: false },
      { word: "b", result: true },
      { word: "ε", result: false },
    ],
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w is non-empty and does not contain two consecutive occurrences of the same symbol }",
    deterministic: false,
  },
  ...
  create12Data: {
    ...
    words: [
      { word: "abaaaba", result: true },
      { word: "abaaba", result: false },
      { word: "baab", result: false },
      { word: "bbab", result: true },
      { word: "bbbb", result: true },
      { word: "ab", result: false },
    ],
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w contains a pair of bs seperated by an odd number of symbols}",
    deterministic: false,
  },
  ...
  create13Data: {
    ...
    words: [
      ...
      { word: "bbbaa", result: true },
      { word: "baabb", result: false },
      { word: "abb", result: false },
      { word: "baaaa", result: true },
    ],
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w has an even number of 'a's, an odd number of 'b's, and does not contain the substring 'ab'",
    deterministic: false,
  },

  nonReg8Data: {
    language:
      "L = {w\u{2208}{a,b}* | w has odd length and the middle symbol is 'a'",
  ...
  nonReg10Data: {
    language:
      "L = {w \u{2208}{a,b}* | in every prefix of w, the number of 'a's is at least the number of 'b's }",
  ...
  create14Data: {
    ...
    words: [
      ...
      { word: "bbab", result: true },
      { word: "baabaa", result: false },
      { word: "ab", result: false },
    ],
    alphabet: ["a", "b"],
    language:
      "L = {w\u{2208}{a,b}* | w contains an equal number of occurrences of the substrings ab and ba}",
    deterministic: false,
  },
  ...
  createLevelData: {
    automata: {
      states: {
        q1: { x: 379, y: 149, accepting: false, transitions: {} },
        q2: {
          x: 146,
          y: 193,
          accepting: false,
