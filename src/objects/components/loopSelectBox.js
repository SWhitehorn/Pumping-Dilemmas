...
export default (scene, repeats) => {
    ...
    return scene.rexUI.add
      ...
      .add(
        scene.rexUI.add
          ...
          .addBackground(
            scene.add
              .rexRoundRectangle(0, 0, 1, 1, { tl: 30 }, colours.DARKBLUE)
          ...
          .add(
            scene.rexUI.add.label({
              ...
              text: scene.add.text(0, 0, repeats, {
                fontSize: "30px",
                fontFamily: "Quantico",
              }),
            }),
        ...
        scene.rexUI.add
          ...
          .add(
            scene.rexUI.add.label({
              ...
              icon: scene.add
                .triangle(0, 0, 5, -3, -7, 6, 5, 15, colours.WHITE)
                .setStrokeStyle(2, colours.BLACK, 1)
                .setInteractive(),
            }),
          ...
          .add(
            scene.rexUI.add.label({
              icon: scene.add
                .triangle(0, 0, 0, -3, 12, 6, 0, 15, colours.WHITE)
                .setStrokeStyle(2, colours.BLACK, 1)
                .setInteractive(),
            }),
    ...
    return scene.rexUI.add
      ...
      .add(
        scene.rexUI.add
          ...
          .addBackground(
            scene.add
              .rexRoundRectangle(0, 0, 1, 1, { tr: 0 }, colours.WHITE)
              .setStrokeStyle(3, 0x010a12),
            "background"
          ),
        { expand: true, key: "top" }
      ...
      .add(
        scene.rexUI.add
          ...
          .addBackground(
            scene.add
              .rexRoundRectangle(0, 0, 1, 1, { br: 0 }, colours.LIGHTBLUE)
              .setStrokeStyle(3, 0x010a12)
          ),
        { expand: true, key: "bottom" }
      );
  };
  ...
  sizer
    .add(createLeft(sizer, repeats), { key: "left" })
