...
export default class LevelSelect extends Phaser.Scene {
  ...
  addUI() {
    ...
    this.UI.title = this.add
      ...
      .setOrigin(0.5);
    this.add
      .rexRoundRectangle(400, 850, 225, 75, 25, colours.DARKBLUE, 1)
      .setStrokeStyle(3, colours.WHITE);
    this.UI.start = this.add
      .text(400, 850, "Start", {
        fontFamily: "Quantico",
        fontSize: "70px",
        color: colours.TEXTWHITE,
